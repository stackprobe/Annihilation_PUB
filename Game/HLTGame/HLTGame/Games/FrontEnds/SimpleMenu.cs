...
namespace HLTStudio.Games.FrontEnds
{
	...
	public class SimpleMenu
	{
		...
		private Action<int> ExtendedDraw;
		...
		public SimpleMenu(int fontSize, int item_l, int itemYSpan, int menu_w, string title, string[] items, Action<int> extendedDraw = null)
		{
			...
			this.Title = title;
			this.Items = items;
			this.ExtendedDraw = extendedDraw;
		...
		public bool Draw()
		{
			...
			this.ExtendedDraw(this.SelectedIndex);
			return false;
		}
	}
}
